...
public class MagicEarlyBirdFilter extends GPUImageFilter {
    ...
    protected void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                mInputTextureHandles[0] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/earlybirdcurves.png");
                mInputTextureHandles[1] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/earlybirdoverlaymap_new.png");
                mInputTextureHandles[2] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/vignettemap_new.png");
                mInputTextureHandles[3] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/earlybirdblowout.png");
                mInputTextureHandles[4] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/earlybirdmap.png");
            }
        });
    }
}
