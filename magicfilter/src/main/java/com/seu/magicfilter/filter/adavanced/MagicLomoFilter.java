...
public class MagicLomoFilter extends GPUImageFilter {
    private int[] mInputTextureHandles = {-1,-1};
    private int[] mInputTextureUniformLocations = {-1,-1};
    ...
    protected void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                mInputTextureHandles[0] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/lomomap_new.png");
                mInputTextureHandles[1] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/vignette_map.png");
            }
        });
    }
}
