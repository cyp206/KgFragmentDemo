...
public class MagicAmaroFilter extends GPUImageFilter {
    ...
    protected void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                mInputTextureHandles[0] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/brannan_blowout.png");
                mInputTextureHandles[1] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/overlaymap.png");
                mInputTextureHandles[2] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/amaromap.png");
            }
        });
    }
}
