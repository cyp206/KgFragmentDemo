...
public class MagicHefeFilter extends GPUImageFilter {
    private int[] mInputTextureHandles = {-1,-1,-1,-1};
    private int[] mInputTextureUniformLocations = {-1,-1,-1,-1};
    ...
    protected void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                mInputTextureHandles[0] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/edgeburn.png");
                mInputTextureHandles[1] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/hefemap.png");
                mInputTextureHandles[2] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/hefemetal.png");
                mInputTextureHandles[3] = OpenGlUtils.loadTexture(MagicParams.getContext(), "filter/hefesoftlight.png");
            }
        });
    }
}
